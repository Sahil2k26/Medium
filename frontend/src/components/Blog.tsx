...
export function Blog({authorName,publishedDate,title,content,id}:input){
    ...
    return <div className="flex flex-col px-5 py-4 items-start justify-evenly border-b-2 border-gray-300 rounded-md max-w-xl lg:w-screen lg:max-w-screen-sm bg-white">
        ...
        <div className="flex items-center justify-start px-3 py-1 gap-4 w-full border-t-2 border-gray-100    "> 
                    ...
                    <button className="flex items-center gap-2 italic" >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4">
